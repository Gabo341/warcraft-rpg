...
//   GET /scenes/brill_arrival?playerId=7bc2722b-81fd-...
// -------------------------------------------------------------

export async function getSceneController(req: Request, res: Response) {

    try {
        // Pega o slug da URL — ex: /scenes/brill_arrival -> slug = 'brill_arrival'
        const { slug } = req.params;

        // Pega o playerId da query string (opcional)
        // ex: /scenes/brill_arrival?playerId=7bc2722b...
